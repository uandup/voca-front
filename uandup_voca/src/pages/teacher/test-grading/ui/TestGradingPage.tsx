          ...
          {statCards.map((card) => (
            ...
            >
              ...
              <div className="flex items-end justify-between">
                <h3 className="font-headline text-3xl font-extrabold text-primary">{card.count}</h3>
                ...
                <tbody className="divide-y divide-surface-container">
                  {mockRecords.map((record) => (
                    <tr key={record.id} className="group hover:bg-surface-bright transition-all">
                      ...
                      <td className="px-6 py-5">
                        <p className="text-sm text-on-surface-variant">{record.date}</p>
                      </td>
                      <td className="px-6 py-5">
                        <span className="text-xs font-bold text-primary">Level {record.level}</span>
                      </td>
                      <td className="px-6 py-5">
                        <span className="font-headline font-bold text-primary">{record.score}</span>
                      </td>
                      <td className="px-6 py-5">
