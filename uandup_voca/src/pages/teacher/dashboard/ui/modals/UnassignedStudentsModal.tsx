...
export function UnassignedStudentsModal({ onClose }: UnassignedStudentsModalProps) {
        ...
        <div className="px-7 py-5 border-b border-outline-variant/30 flex justify-between items-center shrink-0">
          <div>
            ...
            <p className="text-xs text-on-surface-variant mt-0.5">
              {unassigned.length} student{unassigned.length !== 1 ? 's' : ''} without test
              assignment
            </p>
          </div>
          <button
                      ...
                      <div className="bg-white rounded-xl border border-primary/10 p-4 flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            type="number"
                            value={form.quantity}
                            onChange={(e) => setQuantity(student.id, Number(e.target.value))}
                          />
                        </div>
