 ...
 * 최초 진입 시엔 전체화면 시작 게이트로, 이탈 후엔 복귀 유도로 동작한다.
 *
 ...
 */
export function ExamFullscreenGate({ onEnterFullscreen, onExit }: ExamFullscreenGateProps) {
  return (
    <div className="fixed inset-0 z-40 bg-surface flex flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-on-surface-variant max-w-md">
          Questions stay hidden until you return to fullscreen. Leaving fullscreen or switching tabs
          during the exam is recorded and shared with your teacher.
        </p>
      </div>
